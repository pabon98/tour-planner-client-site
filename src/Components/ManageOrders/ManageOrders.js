...
const ManageOrders = () => {
    ...
    useEffect(() => {
        ...
        const url = `https://tour-planner-server-site.vercel.app/orders`;
        fetch(url)
            .then(res => res.json())
            .then(data => {
                setOrders(data)
    ...
    const handleApproveOrder = (id) => {
        ...
        const url = `https://tour-planner-server-site.vercel.app/approve/${id}`;
        fetch(url, {
            method: 'PUT',
            headers: {
    ...
    const handleCancelOrder = (id) => {
        ...
        if (proceed) {
            const url = `https://tour-planner-server-site.vercel.app/deleteOrder/${id}`
